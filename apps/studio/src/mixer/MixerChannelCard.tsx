...
export const MixerChannelCard = memo(function MixerChannelCard({
  label,
  volume,
  pan,
  mute,
  ...
  return (
    <div
      className={`flex flex-col items-center gap-1 p-2 rounded ${isMaster ? "bg-accent-bg/20" : "bg-elevated"} min-w-14`}
    >
