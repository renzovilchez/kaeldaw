...
const DEFAULT_PRESETS: InstrumentPreset[] = [
  ...
  { id: "poly-riser", name: "Riser FX", category: "FX", icon: "💥", config: { oscillatorType: "saw", filterCutoff: 2000, filterResonance: 0.5, ampEnvAttack: 0.5, ampEnvDecay: 0, ampEnvSustain: 0.8, ampEnvRelease: 0.5, volume: 0.4, pitchEnvAmount: 24, pitchEnvAttack: 1 } },
];
