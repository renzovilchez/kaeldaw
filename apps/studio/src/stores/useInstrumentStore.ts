...
const DEFAULT_PRESETS: InstrumentPreset[] = [
  { id: "poly-saw", name: "Saw Lead", category: "Synths", icon: "🎛", config: { oscillatorType: "saw", filterCutoff: 12000, filterResonance: 0.1, ampEnvAttack: 0.01, ampEnvDecay: 0.1, ampEnvSustain: 0.7, ampEnvRelease: 0.15, volume: 0.4 } },
  { id: "poly-sine", name: "Sine Pad", category: "Synths", icon: "🎛", config: { oscillatorType: "sine", filterCutoff: 8000, filterResonance: 0, ampEnvAttack: 0.05, ampEnvDecay: 0.2, ampEnvSustain: 0.6, ampEnvRelease: 0.15, volume: 0.35 } },
  { id: "poly-square", name: "Square Wave", category: "Synths", icon: "🎛", config: { oscillatorType: "square", filterCutoff: 6000, filterResonance: 0.2, ampEnvAttack: 0.01, ampEnvDecay: 0.05, ampEnvSustain: 0.4, ampEnvRelease: 0.15, volume: 0.3 } },
